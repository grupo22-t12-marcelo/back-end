...
export class createTables1677796305618 implements MigrationInterface {
  name = "createTables1677796305618";

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "imageProduct" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "image1" character varying NOT NULL, "image2" character varying NOT NULL, "image3" character varying NOT NULL, "image4" character varying NOT NULL, "image5" character varying NOT NULL, "image6" character varying NOT NULL, "productId" uuid, CONSTRAINT "REL_9537ce066328b3798d26dd169c" UNIQUE ("productId"), CONSTRAINT "PK_3115573fd248828575fda62a9bb" PRIMARY KEY ("id"))`
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "imageProduct" ADD CONSTRAINT "FK_9537ce066328b3798d26dd169c5" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE NO ACTION`
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "imageProduct" DROP CONSTRAINT "FK_9537ce066328b3798d26dd169c5"`
    );
