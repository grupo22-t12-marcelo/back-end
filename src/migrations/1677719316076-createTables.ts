...
export class createTables1677719316076 implements MigrationInterface {
    name = 'createTables1677719316076'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "imageProduct" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "image1" character varying NOT NULL, "image2" character varying, "image3" character varying, "image4" character varying, "image5" character varying, "image6" character varying, "productId" uuid, CONSTRAINT "REL_9537ce066328b3798d26dd169c" UNIQUE ("productId"), CONSTRAINT "PK_3115573fd248828575fda62a9bb" PRIMARY KEY ("id"))`);
